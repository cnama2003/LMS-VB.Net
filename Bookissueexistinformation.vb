...
Public Class Bookissueexistinformation
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If Txt1.Text IsNot "" Then
            Dim cmd As New SqlCommand("Select *from Bookissueinformation Where Bookid = @Bookid", Conn)
        ...
        Else
            Dim cmd1 As New SqlCommand("Select *from Bookissueinformation", Conn)

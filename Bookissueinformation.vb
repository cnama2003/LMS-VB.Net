...
Public Class Bookissueinformation
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        connection.Open()
        Dim insert As String = "insert into Bookissueinformation(Bookid,Studentid,Studentname,Dateofissue,Submissiondate,course) values(@Bookid,@Studentid,@Studentname,@Dateofissue,@Submissiondate,@Course)"
